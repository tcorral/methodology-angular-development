...
This stylguide is aimed at front-end developers interested in developing widgets for the Backbase CXP platform using the [AngularJS](https://angularjs.org/) framework. The objective is to:
